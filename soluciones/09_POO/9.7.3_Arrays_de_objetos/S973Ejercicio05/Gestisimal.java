...
public class Gestisimal {
	...
	public static void main(String[] args) {
		...
		int opcion, primeraLibre, i, stockIntroducido;
		double precioDeCompraIntroducido, precioDeVentaIntroducido;
		String codigo, codigoIntroducido = "", descripcionIntroducida, precioDeCompraIntroducidoString, precioDeVentaIntroducidoString, stockIntroducidoString;
