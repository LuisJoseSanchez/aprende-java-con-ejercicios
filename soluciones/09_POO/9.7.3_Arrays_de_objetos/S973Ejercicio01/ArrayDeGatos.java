/**
 * 
 * 1. Utiliza la clase Gato para crear un array de cuatro gatos e introduce
 *    los datos de cada uno de ellos mediante un bucle. Muestra a continuación
 *    los datos de todos los gatos utilizando también un bucle.
 * 
