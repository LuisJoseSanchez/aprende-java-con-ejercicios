...
public class S04Ejercicio08 {
	...
	public static void main(String[] args) {
		...
		if (media < 5) System.out.print("Insuficiente");
		if ((media >= 5) && (media < 6)) System.out.print("Suficiente");
		if ((media >= 6) && (media < 7)) System.out.print("Bien");
		if ((media >= 7) && (media < 9)) System.out.print("Notable");
		if (media >= 9) System.out.print("Sobresaliente");	
	}
}
