 ...
 *     "final". Se debe comprobar que inicial es menor que fnal y que ambos números están
 *     entre 0 y 9. El programa deberá colocar el número de la posición inicial en la posición
 *     final, rotando el resto de números para que no se pierda ninguno. Al fnal se debe mostrar
 *     el array resultante.
 *
...
public class S71Ejercicio12 {
	...
	public static void main(String[] args) {
		...
		System.out.println("│\n├────────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┤");		
		System.out.print("│ Valor  ");
		for (i = 0; i < 10; i++) System.out.printf("│%4d ", resultado[i]);
		System.out.println("│\n└────────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┘");	
	}
}
