 ...
 * 
 *    Nota: Ajusta el tamaño de letra y las dimensiones del terminal para ver el resultado correctamente.
 *
...
public class S71Ejercicio06 {
	...
	public static void main(String[] args) {
			...
			for (i = 0; i < 15; i++) System.out.printf("|%4d ", i);
			System.out.println("|");
			for (i = 0; i < 90; i++) System.out.print("-");
			System.out.println("-");
			for (i = 0; i < 15; i++) System.out.printf("|%4d ", numero[i]);
			System.out.println("|");
